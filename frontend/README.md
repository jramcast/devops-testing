...
Launches the test runner in the interactive watch mode and includes coverage.

### `yarn test:ci`

Runs the tests without watch mode and includes coverage.

### `yarn lint`

Run ESLint and fix changes. See `.eslintrc.json` for configuration.

### `yarn format`

Run the Prettier code formatter to format files. See `.prettierrc` for configuration and/or http://prettier.io for more information.
